...
/**
 * Overrides the createCall method to return a new SqlCausalImpact.
 * It also overrides the unparser method to define how the CAUSAL IMPACT
 * keyword should be unparsed to SQL.
 */
